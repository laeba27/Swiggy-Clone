...
const Home = () => {
  ...
  //   const filterednewarray = restaurants.filter(
  //     (item) => item?.info?.isNewOnSwiggy
  // }
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="max-w-[68rem] pt-7 mx-auto flex flex-col items-start gap-4 ">
            <h1 className="text-2xl font-bold ">
              Laeba, {"what's"} on your mind?
            </h1>
            <div className="flex gap-3 overflow-x-auto lg:max-w-[68rem] md:max-w-[48rem] max-w-[38rem] mx-auto ">
              {category && category.length > 0
                ...
                : Array.from({ length: 19 }).map((index) => (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4  pt-6 lg:grid-cols-4 lg:gap-8 my-6">
          ...
          <div>
            <h1 className="text-2xl font-bold ">Best places across the cities</h1>
